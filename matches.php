...
<div class="d-flex align-items-center justify-content-center">
  <h1 class="m-2">Partite Disponibili</h1>
  <!-- filter dropdown-->
  <div class="dropdown">
    ...
    <button class="btn" id="no_filter_btn"><img src="./Media/filter.png" style="height: 30px; width: 30px;" /></button>
    <button class="btn" id="soccer_filter_btn"><img src="./Media/soccer_filter.png" style="height: 30px; width: 30px;" /></button>
    <button class="btn" id="volley_filter_btn"><img src="./Media/volley_filter.png" style="height: 30px; width: 30px;" /></button>
    <button class="btn" id="tennis_filter_btn"><img src="./Media/tennis_filter.png" style="height: 30px; width: 30px;" /></button>
    <button class="btn" id="baseball_filter_btn"><img src="./Media/baseball_filter.png" style="height: 30px; width: 30px;" /></button></div>
  </div>
</div>
<script src="./Functions/filter.js"></script>
<!--Matches table-->
<table class="mx-1"style="width:100%">
        <tr class="bg_lblue">
        <th >ID</th>
